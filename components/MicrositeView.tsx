        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col items-center justify-center space-y-4">
            ...
            <p className="text-sm text-gray-500 text-center">
              Personalized microsite for {microsite.companyName} • Powered by <a href="https://mosaiccorp.com" target="_blank" rel="noopener noreferrer" className="font-semibold hover:underline" style={{ color: microsite.colors.primary }}>Mosaic Corporation</a>
            </p>
          </div>
        </div>
      </div>
